...
document.addEventListener("DOMContentLoaded", () => {
    fetch('http://192.168.1.106:3000/api/getMain1')
    ...
    fetch('http://192.168.1.106:3000/api/getMain2')
        .then(response => response.json())
        .then(data => {
...
document.getElementById("updateForm").addEventListener("submit", async function (event) {
    ...
    try {
        const response = await fetch("http://192.168.1.106:3000/api/getStockData", {
            method: "POST",
